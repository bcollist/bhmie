...
// Function Prototypes
int bhmie(double x,double refrel,int nang, double* Qscat_p, double* Qext_p, double* Qback_p);
...
int bhmie(double x,double refrel,int nang){
    ...
    // Assign arrays that will be exported to the value of their pointers
    dx = x;
    y = x * refrel;
